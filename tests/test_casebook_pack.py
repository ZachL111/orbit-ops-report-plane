"""Regression checks for the orbit-ops-report-plane casebook."""
...
from casebook.harness import assert_expected, orbit_ops_report_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_ops_report_plane_summary(), assert_expected())
